...
\begin{frame}{Gêmeos Digitais}
  ...
  \begin{itemize}
    ...
    \item {
      Oportunidade: Criar uma estrutura de dados a partir do programa
      \emph{CN} para fornecer um modelo virtual da usinagem da peça na 
      máquina-ferramenta.
    }
  \end{itemize}
...
\subsection{Padrão \emph{RS274-D}}

\begin{frame}{Origem do padrão \emph{RS274-D}}
  \begin{itemize}
  \item {
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=87mm]{images/fita-perfurada.jpg}
  \end{figure}
...
\begin{frame}{Arquitetura do padrão \emph{RS274-D}}
  \begin{itemize}
  \item {
...
\begin{frame}{Dialetos do padrão \emph{RS274-D}}
  \begin{itemize}
  \item {
...
\subsection{Padrão \emph{STEP-NC}}

\begin{frame}{Origem do padrão \emph{STEP-NC}}
  \begin{itemize}
  \item {
...
\begin{frame}{Objetivos do padrão \emph{STEP-NC}}
  \begin{itemize}
    \item {
...
\begin{frame}{Trecho de arquivo \emph{STEP-NC}}
...
\begin{frame}{Considerações sobre o padrão \emph{STEP-NC}}
...
\begin{frame}{Objetivos das Funções Canônicas de Usinagem}
  \begin{itemize}    
    \item {
...
\begin{frame}{Exemplos de Funções Canônicas de Usinagem}
  \begin{table}[H]
    \centering
    \begin{tabular}{p{7cm}|p{5cm}}
...
\begin{frame}{Considerações sobre as Funções Canônicas de Usinagem}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Ambiente de desenvolvimento em \emph{Docker}, 
          imagem \emph{Linux Debian Bullseye}.
...
\begin{frame}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=65mm]{images/img-pc-teste.jpg}
  \end{figure}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Para o cálculo dos tempos utilizados nos gráficos apresentados
          não foi levado em conta a aceleração e o tranco (\emph{jerk}) 
          da máquina Discovery 4022. Entretanto, esses parâmetros podem 
          ser incluídos na classe \emph{Machine}, que é uma classe 
          que representa a máquina física.
    \item As rotinas para cálculo do ajuste do contorno para fins de 
          compensação do raio de corte (\emph{CRC}) não foram 
          implementadas. 
          Embora as \emph{CRCs} não tenham sido utilizadas no estudo de 
          caso aqui reportado, elas afetam os percursos de avanço e, por 
          conseguinte, o tempo de usinagem e devem ser consideradas em 
...
\begin{frame}
  ...
  \begin{itemize}
    \item O presente trabalho propôs uma metodologia para interpretar 
...
\begin{frame}
  ...
  \begin{itemize}
    \item Conclui-se que a abordagem proposta foi capaz de fornecer um 
          modelo virtual do que vai ocorrer durante a usinagem na 
          máquina-ferramenta, levando em conta as características da 
          máquina e o dialeto utilizado.
    \item Além disso, o arquivo das Funções Canônicas de Usinagem podem 
          fornecer uma camada intermedi\'aria de abstra\c c\~ao para a 
          integração com outros sistemas, pois apresentam um formato 
          portável e padronizado.
    \item Como trabalho futuro, sugere-se o desenvolvimento de um Gêmeo 
          Digital para o monitoramento do processo de usinagem, com o 
          emprego de sensores ou outros dispositivos para medir grandezas 
          que possam ser relacionadas com os eventos que ocorrem na 
          usinagem (por exemplo, potência elétrica e força).
  \end{itemize}
